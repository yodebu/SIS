...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr class="white">
	...
	<form id="form1" name="form1" method="post" action="namewisesearch.php">
              <label></label>
        <label>
                        <span class="menu">Enter Name </span><br />
                        <input name="searchname" type="text" class="menu" id="searchname" size="25" maxlength="200" />

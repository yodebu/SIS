...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr class="white">
    <td align="left" valign="top" class="white"><table width="99%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td width="4%" valign="top" class="text_black_bold"><a href="information2003Search.php">Go Back to Main Page </a></td>
        <td width="96%" align="left" valign="top">
				   ...
				   <form id="form" name="form" method="post" action= 'insertdata1.php' > 
			...
			$Query="INSERT INTO batch2003 (En_no,Name,Discipline,Fathers_Name,Description,Semester) VALUES ( '$En_no','$name','$discipline','$F_name','$description','$semester');"; 

...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr class="white">
    <td align="left" valign="top" class="text_black_huge"><p>Discipline And Semester  : </p>
...
$sem = !isset($_POST['semester'])? NULL : $_POST['semester']; 
...
if($disc =='' or $sem == '')
			{
			echo 'Please select the value from both fields ';
			return false;
			}
		echo 'Your selection is  '. $disc .' And '. $sem;	
$Query="SELECT * from batch2003 where Discipline = '" .$disc. "'and Semester = '".$sem."'"  ;
